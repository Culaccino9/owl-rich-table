...
exports.createDefaultRow = createDefaultRow;
exports.createRow = createRow;
exports.getPasteValue = getPasteValue;
 ...
 * 初始化一条cell
 */
function createCell(cell, coord, incrementKey) {
  return _objectSpread(_objectSpread({}, cell), {}, {
    incrementKey: incrementKey,
    key: (0, _common.createCellKey)(coord, incrementKey)
  });
}
 ...
 * 初始化一条row
 */
function createRow(col, incrementKey, colIndex, rowIncrementKey) {
  return {
    key: (0, _common.createRowKey)(colIndex, incrementKey),
 ...
 * 初始化新增，默认无value的行
 */
function createDefaultRow(length, incrementKey, colIndex) {
  var _Array$fill;
...
function initData(data) {
  ...
  if (!Array.isArray(data)) {
    return {
      ...
      width: [_shape.DEFAULT_WIDTH],
      height: [_shape.DEFAULT_HEIGHT]
    };
  }
